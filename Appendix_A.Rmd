...
This appendix aims to illustrate the process of calibrating five variants of a
disaggregated SEIR model to synthetic data via the Nelder-Mead algorithm and 
...
ggsave("./plots/A_incidence_reports.pdf", dpi = "print", height = 5, width = 8)
```
...
g_for_plot <- grid.arrange(pred_K, grey_actual_K, ncol = 2)

ggsave(file = "./plots/A_WAIFW_sym_HMC.pdf", g_for_plot, dpi = "print",
       height = 3, width = 6)
```
...
ggsave("./plots/A_incidence_fit_perfect_info.pdf", dpi = "print", height = 3,
       width = 8)
```
...
ggsave("./plots/A_incidence_fit_underreporting.pdf", dpi = "print", height = 3,
       width = 8)
```
...
ggsave("./plots/A_R0comparison.pdf", dpi = "print", height = 5,
       width = 8)
```
...
ggsave("./plots/A_WAIFWcomparison.pdf", dpi = "print", height = 5,
       width = 8)
```
