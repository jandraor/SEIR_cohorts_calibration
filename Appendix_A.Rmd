...
cpt <- "SEIR D's trace plot. Each panel corresponds to the four separate parameters in this configuration.\nFour Markov chains are displayed per panel. The shaded area indicates the warm-up period."  
...
cpt <- "Computational time spent on fitting each model variant by calibration method."
