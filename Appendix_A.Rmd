...
MASEs <- purrr::map(summaries_optim_A, "metrics") %>% 
  map_dbl("avg_MASE")

names(MASEs)         <- 1:n_inits
sorted_MASEs         <- sort(MASEs)
top_6                <- sorted_MASEs[1:6]
top_id               <- which(MASEs %in% top_6)
top_optim_A          <- summaries_optim_A[top_id]
summary_optim[[mtx]] <- summaries_optim_A[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_B, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_optim[[mtx]] <- summaries_optim_B[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_C, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_optim[[mtx]] <- summaries_optim_C[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_D, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_optim[[mtx]] <- summaries_optim_D[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_sym, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_optim[[mtx]] <- summaries_optim_sym[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_und_A, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_und_optim[[mtx]] <- summaries_optim_und_A[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_und_B, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_und_optim[[mtx]] <- summaries_optim_und_B[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_und_C, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_und_optim[[mtx]] <- summaries_optim_und_C[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_und_D, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_und_optim[[mtx]] <- summaries_optim_und_D[[which.min(MASEs)]]
...
MASEs <- purrr::map(summaries_optim_und_sym, "metrics") %>% 
  map_dbl("avg_MASE")
...
summary_und_optim[[mtx]] <- summaries_optim_und_sym[[which.min(MASEs)]]
...
```{r}
MSEs             <- map_dbl(summary_stan, extract_K_error) 
K_error_stan_prf <-data.frame(matrix     = m_index,
                                MSE      = MSEs,
                                method   = "HMC",
                                scenario = "Perfect information")

MSEs             <- map_dbl(summary_stan_und, extract_K_error)
K_error_stan_und <- data.frame(matrix   = m_index,
                                MSE      = MSEs,
                                method   = "HMC",
                                scenario = "Underreporting")

MSEs              <- map_dbl(summary_optim, "MSE_K")
K_error_optim_prf <- data.frame(matrix   = m_index,
                                MSE      = MSEs,
                                method   = "NMS",
                                scenario = "Perfect information")

MSEs              <- map_dbl(summary_und_optim, "MSE_K")
...
ggplot(K_error_df, aes(x = matrix, y = MSE)) +
  geom_lollipop(aes(colour = is_min)) +
