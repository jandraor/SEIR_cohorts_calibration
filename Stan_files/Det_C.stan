functions {
  vector SEIR_matrix_C(real time, vector y, real[] params) {
    ...
    RI3 = InR3;
    RI4 = InR4;
    IR1 = y[1]*(params[1]*y[3]+k12*y[7]+params[2]*y[11]+k14*y[15])/10000;
    IR2 = y[5]*(k21*y[3]+params[3]*y[7]+k23*y[11]+k24*y[15])/10000;
    IR3 = y[9]*(k31*y[3]+k32*y[7]+k33*y[11]+k34*y[15])/10000;
...
transformed parameters{
  ...
  y_hat = ode_rk45(SEIR_matrix_C, y0, t0, ts, params);
