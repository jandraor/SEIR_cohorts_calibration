functions {
  vector SEIR_matrix_sym(real time, vector y, real[] params) {
    ...
    real IR3;
    real IR4;
    IR1 = y[1]*(params[1]*y[3]+params[2]*y[7]+params[3]*y[11]+params[4]*y[15])/999999;
    InR1 = y[2]/1;
    RR1 = y[3]/2;
    InR2 = y[6]/1;
    RR2 = y[7]/2;
    ...
    RI3 = InR3;
    RI4 = InR4;
    IR2 = y[5]*(k21*y[3]+params[5]*y[7]+params[6]*y[11]+params[7]*y[15])/999999;
    IR3 = y[9]*(k31*y[3]+k32*y[7]+params[8]*y[11]+params[9]*y[15])/999999;
    IR4 = y[13]*(k41*y[3]+k42*y[7]+k43*y[11]+params[10]*y[15])/999999;
    dydt[1] = -IR1;
    dydt[2] = IR1-InR1;
    dydt[3] = InR1-RR1;
    dydt[4] = RR1;
