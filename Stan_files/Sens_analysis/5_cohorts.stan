functions {
  vector SEIR_matrix_sym(real time, vector y, real[] params) {
    ...
    RI3 = InR3;
    RI4 = InR4;
    lambda1 = params[1]*y[3]+params[2]*y[7]+params[3]*y[11]+params[4]*y[15]+params[5]*y[23];
    InR5 = y[22]/1;
    RR5 = y[23]/2;
    RI5 = InR5;
    lambda2 = k21*y[3]+params[6]*y[7]+params[7]*y[11]+params[8]*y[15]+params[9]*y[23];
    lambda3 = k31*y[3]+k32*y[7]+params[10]*y[11]+params[11]*y[15]+params[12]*y[23];
    lambda4 = k41*y[3]+k42*y[7]+k43*y[11]+params[13]*y[15]+params[14]*y[23];
    k54 = params[14];
    k53 = params[12];
    k51 = params[5];
    k52 = params[9];
    ...
    lambda5 = k51*y[3]+k52*y[7]+k53*y[11]+k54*y[15]+params[15]*y[23];
...
generated quantities {
  real log_lik;
  log_lik = poisson_lpmf(y1 | incidence1) + poisson_lpmf(y2 | incidence2) + poisson_lpmf(y3 | incidence3) + poisson_lpmf(y4 | incidence4) + poisson_lpmf(y5 | incidence5);
}
